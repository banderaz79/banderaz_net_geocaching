...
<head>
	<meta charset="utf-8">
	<meta name="description" content="Проверка дипломов Железные дороги">
	<link rel="stylesheet" type="text/css" href="../../css/style.css" />
	<title>Проверка дипломов Железные дороги</title>
</head>
<body>
	<div class="main" >
		<form enctype="multipart/form-data" action="proverka.php" method="post" style="text-align: center;">
			<div><p style="text-align: center; margin: 0px;"><a href="http://geocaching.su" target="blank"><img src="../../media/gc.png" /></a></p></div>
			<div>
				Выберите заявку на диплом Железные дороги (сохраненный из Excel в формате CSV (разделители - запятые))<br /><br />
